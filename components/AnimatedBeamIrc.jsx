...
export function AnimatedBeamIrc() {
    ...
    >
      <div className="flex size-full flex-col max-w-2xl max-h-[200px] items-stretch justify-between gap-10">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref} className="bg-gray-900">
            <FaTruckMonster size={50}/>
          </Circle>
          <Circle ref={div5Ref} className="bg-gray-900">
            <PiCarSimpleLight size={50}/>
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref} className="bg-gray-900">
            <GiF1Car size={50}/>
          </Circle>
          <Circle ref={div4Ref} className="size-20 bg-black">
            <Image src={logo} />
          </Circle>
          <Circle ref={div6Ref} className="bg-gray-900">
            <GiMechanicalArm size={50}/>
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref} className="bg-gray-900">
            <TbCarSuv size={50}/>
          </Circle>
...
const Icons = {
  ...
  googleDrive: function GoogleDriveIcon() {
    return (
      <svg
        width="100"
        height="100"
  ...
  whatsapp: function WhatsappIcon() {
    return (
      <svg
        width="100"
        height="100"
  ...
  googleDocs: function GoogleDocsIcon() {
    return (
      <svg
        width="47px"
        height="65px"
  ...
  messenger: function MessengerIcon() {
    return (
      <svg
        width="100"
        height="100"
